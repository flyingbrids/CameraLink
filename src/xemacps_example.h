...
#define TOTALHEADERSIZE     28
#define PAYLOADSIZE         1470
#define ETHERNET_SIZE       4292400
...
LONG EmacPsUtilEnterLoopback(XEmacPs *XEmacPsInstancePtr, u32 Speed, u8 loopbackEn);
